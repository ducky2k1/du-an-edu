...
<script src="../doc/js/jquery-3.2.1.min.js"></script>
    ...
    <!-- Data table plugin-->
    <script type="text/javascript" src="../doc/js/plugins/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="../doc/js/plugins/dataTables.bootstrap.min.js"></script>
