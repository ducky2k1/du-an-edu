    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            <form class="row" action="../controller/index.php?act=add_ca" method="post">
              ...
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="time" name="time-start">
                <span class="" style="color:red;"><?= $errer['time-start'] ?? "" ?></span>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Thời gian kết thúc</label>
                <input class="form-control" type="time" name="time-end">
