    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            <form class="row" action="../controller/index.php?act=up_pro&id=<?php extract($edit_pro); echo $id ?>" method="post">
            <div class="form-group col-md-3">
                <label class="control-label">Id khóa học</label>
                <input class="form-control" type="text" name="id" readonly value="<?php extract($edit_pro); echo $id ?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Tên khóa học</label>
                <input class="form-control" type="text" name="ten" value="<?php extract($edit_pro); echo $name ?>">
                <span class="" style="color:red;"><?= $errer['ten'] ?? "" ?></span>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Giá khóa học</label>
                <input class="form-control" type="text" name="gia" value="<?php extract($edit_pro); echo $price ?>">
                <span class="" style="color:red;"><?= $errer['gia'] ?? "" ?></span>
              </div>
              <div class="form-group col-md-12">
                <label class="control-label">Mô tả sản phẩm</label>
                <input class="form-control" type="text" name="mota" id="mota" value="<?php extract($edit_pro); echo $mo_ta ?>"></input>
