                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="./index.php?act=dn" method="post">
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <input type="submit" name="dang_nhap" value="Đăng nhập" class="btn btn-primary btn-lg">

                                            <!-- <button type="button" class="btn btn-primary btn-lg" name="dang_nhap">Sign In</button> -->
                                        </div>
