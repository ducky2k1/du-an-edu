<?php
    function order_selectAll(){
        ...
        dtb_member.phone,dtb_member.email,dtb_member.location, dtb_course.price , dtb_order.date_buy , dtb_lop.name as class_name
        ...
        JOIN dtb_lop ON dtb_order_item.lop_id = dtb_lop.id";
